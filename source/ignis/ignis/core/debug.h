#ifndef IGNIS_CORE_DEBUG_H
#define IGNIS_CORE_DEBUG_H
...
#  define LOG_FILE_OUTPUT_PATH "./onia.logs"
#endif
...
#define _OINTL_LOG(_lv, ...)                                                   \
  _intl_print_log(LOG_SEVERITY_##_lv, __LINE__, __FILE__, __FUNCTION__,        \
                  __VA_ARGS__)

#define VERBOSE(...) _OINTL_LOG(VERBOSE, __VA_ARGS__)
#define TRACE(...)   _OINTL_LOG(TRACE, __VA_ARGS__)
#define INFO(...)    _OINTL_LOG(INFO, __VA_ARGS__)
#define ERROR(...)   _OINTL_LOG(ERROR, __VA_ARGS__)
#define WARNING(...) _OINTL_LOG(WARNING, __VA_ARGS__)
#define FATAL(...)                                                             \
  _OINTL_LOG(FATAL, __VA_ARGS__);                                              \
  O_GENERATE_TRAP()
